...
class StorefrontAccessTokenTest(TestCase):
    def test_create_storefront_access_token(self):
        ...
        storefront_access_token = shopify.StorefrontAccessToken.create(
            {"title": "Test"}
        )
    ...
    def test_get_and_delete_storefront_access_token(self):
        ...
        self.fake(
            "storefront_access_tokens/1", method="DELETE", code=200, body="destroyed"
        )
