...
class ArticleTest(TestCase):
    ...
    def test_get_articles_namespaced(self):
        self.fake(
            "blogs/1008414260/articles",
            method="GET",
            body=self.load_fixture("articles"),
        )
    ...
    def test_get_article_namespaced(self):
        self.fake(
            "blogs/1008414260/articles/6242736",
            method="GET",
            body=self.load_fixture("article"),
        )
    ...
    def test_get_authors_for_blog_id(self):
        self.fake(
            "blogs/1008414260/articles/authors",
            method="GET",
            body=self.load_fixture("authors"),
        )
    ...
    def test_get_tags_for_blog_id(self):
        self.fake(
            "blogs/1008414260/articles/tags",
            method="GET",
            body=self.load_fixture("tags"),
        )
    ...
    def test_get_popular_tags(self):
        self.fake(
            "articles/tags.json?limit=1&popular=1",
            extension=False,
            method="GET",
            body=self.load_fixture("tags"),
        )
