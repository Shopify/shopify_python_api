...
class GiftCardTest(TestCase):
    def test_gift_card_creation(self):
        ...
        gift_card = shopify.GiftCard.create(
            {"code": "d7a2bcggda89c293", "note": "Gift card note."}
        )
    ...
    def test_fetch_gift_cards(self):
        self.fake(
            "gift_cards", method="GET", code=200, body=self.load_fixture("gift_cards")
        )
    ...
    def test_adjust_gift_card(self):
        ...
        adjustment = gift_card.add_adjustment(
            shopify.GiftCardAdjustment({"amount": 100})
        )
    ...
    def test_search(self):
        self.fake(
            "gift_cards/search.json?query=balance%3A10",
            extension=False,
            body=self.load_fixture("gift_cards_search"),
        )
