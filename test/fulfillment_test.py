...
class FulFillmentTest(TestCase):
    def setUp(self):
        ...
        self.fake(
            "orders/450789469/fulfillments/255858046",
            method="GET",
            body=self.load_fixture("fulfillment"),
        )
    ...
    def test_update_tracking(self):
        ...
        update_tracking = update_tracking.replace(
            b"http://www.google.com/search?q=1Z2345", b"http://www.my-url.com"
        )
        ...
        self.assertEqual(
            "http://www.google.com/search?q=1Z2345", fulfillment.tracking_url
        )
