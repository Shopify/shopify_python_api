...
class DraftOrderTest(TestCase):
    ...
    def test_get_all_draft_orders(self):
        self.fake(
            ...
            method="GET",
            code=200,
            body=self.load_fixture("draft_orders"),
        )
    ...
    def test_create_draft_order(self):
        ...
        self.assertEqual(
            json.loads(
                '{"draft_order": {"line_items": [{"quantity": 1, "variant_id": 39072856}]}}'
            ),
    ...
    def test_update_draft_order(self):
        ...
        self.assertEqual(
            "Test new note",
            json.loads(self.http.request.data.decode("utf-8"))["draft_order"]["note"],
        )
    ...
    def test_send_invoice_with_no_params(self):
        ...
        self.assertEqual(
            json.loads('{"draft_order_invoice": {}}'),
            json.loads(self.http.request.data.decode("utf-8")),
        )
        self.assertIsInstance(draft_order_invoice_response, shopify.DraftOrderInvoice)
        self.assertEqual(
            draft_order_invoice["draft_order_invoice"]["to"],
            draft_order_invoice_response.to,
        )
    ...
    def test_send_invoice_with_params(self):
        ...
        self.assertEqual(
            draft_order_invoice, json.loads(self.http.request.data.decode("utf-8"))
        )
        self.assertIsInstance(draft_order_invoice_response, shopify.DraftOrderInvoice)
        self.assertEqual(
            draft_order_invoice["draft_order_invoice"]["to"],
    ...
    def test_get_metafields_for_draft_order(self):
        self.fake(
            "draft_orders/517119332/metafields", body=self.load_fixture("metafields")
        )
    ...
    def test_complete_draft_order_with_no_params(self):
        ...
        self.fake(
            "draft_orders/517119332/complete",
            method="PUT",
    ...
    def test_complete_draft_order_with_params(self):
        ...
        self.fake(
            url, extension=False, method="PUT", body=completed_fixture, headers=headers
        )
