...
class SessionTest(TestCase):
    ...
    def test_ignore_everything_but_the_subdomain_in_the_shop(self):
        session = shopify.Session(
            "http://user:pass@testshop.notshopify.net/path", "unstable", "any-token"
        )
        self.assertEqual(
            "https://testshop.myshopify.com/admin/api/unstable", session.site
        )
    ...
    def test_raise_error_if_params_passed_but_signature_omitted(self):
        with self.assertRaises(shopify.ValidationException):
            ...
            token = session.request_token(
                {"code": "any_code", "foo": "bar", "timestamp": "1234"}
            )
    ...
    def test_temp_reset_shopify_ShopifyResource_site_to_original_value(self):
        ...
        self.assertEqual(
            "https://testshop.myshopify.com/admin/api/unstable", assigned_site
        )
        self.assertEqual(
    ...
    def test_myshopify_domain_supports_non_standard_ports(self):
        try:
            shopify.Session.setup(
                api_key="key", secret="secret", myshopify_domain="localhost", port=3000
            )
    ...
    def test_temp_works_without_currently_active_session(self):
        ...
        self.assertEqual(
            "https://none/admin/api/unstable", shopify.ShopifyResource.site
        )

    def test_create_permission_url_returns_correct_url_with_single_scope_and_redirect_uri(
        self
    ):
    ...
    def test_create_permission_url_returns_correct_url_with_dual_scope_and_redirect_uri(
        self
    ):
        shopify.Session.setup(api_key="My_test_key", secret="My test secret")
        session = shopify.Session("http://localhost.myshopify.com", "unstable")
    ...
    def test_create_permission_url_returns_correct_url_with_no_scope_and_redirect_uri_and_state(
        self
    ):
        shopify.Session.setup(api_key="My_test_key", secret="My test secret")
        session = shopify.Session("http://localhost.myshopify.com", "unstable")
        ...
        permission_url = session.create_permission_url(
            scope, "my_redirect_uri.com", state="mystate"
        )
        self.assertEqual(
    ...
    def test_create_permission_url_returns_correct_url_with_single_scope_and_redirect_uri_and_state(
        self
    ):
        shopify.Session.setup(api_key="My_test_key", secret="My test secret")
        session = shopify.Session("http://localhost.myshopify.com", "unstable")
    ...
    def test_hmac_calculation_with_ampersand_and_equal_sign_characters(self):
        ...
        expected_hmac = hmac.new(
            "secret".encode(), to_sign.encode(), sha256
        ).hexdigest()
    ...
    def test_hmac_validation(self):
        ...
        params = {
            ...
            "timestamp": "1337178173",
            "hmac": u(
                "2cb1a277650a659f1b11e92a4a64275b128e037f2c3390e3c8fd2d8721dac9e2"
            ),
        }
    ...
    def test_param_validation_of_param_values_with_lists(self):
        ...
        params = {
            ...
            "ids[]": [2, 1],
            "hmac": u(
                "b93b9f82996f6f8bf9f1b7bbddec284c8fabacdc4e12dc80550b4705f3003b1e"
            ),
        }
    ...
    def test_raise_error_if_hmac_is_invalid(self):
        ...
        params[
            "hmac"
        ] = "a94a110d86d2452e92a4a64275b128e9273be3037f2c339eb3e2af4cfb8a3828"
