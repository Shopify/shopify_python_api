...
class LimitsTest(TestCase):
    def setUp(self):
        ...
        # ShopifyResource = shopify.ShopifyResource.connection.response.get
        #
        # patcher = patch(
        #     ShopifyResource,
        #     side_effect=self.mock_limit_headers
        # )
        #
        # patcher.start()
    ...
    #
    #     with patch(
    #             'shopify.ShopifyResource.connection.response.get',
    #             side_effect=self.mock_limit_headers_max) as mock:
