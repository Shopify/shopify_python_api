...
class ImageTest(TestCase):
    ...
    def test_get_images(self):
        self.fake(
            "products/632910392/images", method="GET", body=self.load_fixture("images")
        )
    ...
    def test_get_image(self):
        self.fake(
            "products/632910392/images/850703190",
            method="GET",
            body=self.load_fixture("image"),
        )
    ...
    def test_get_metafields_for_image(self):
        fake_extension = (
            "json?metafield[owner_id]=850703190&metafield[owner_resource]=product_image"
        )
        self.fake(
            "metafields",
            method="GET",
