...
class PriceRuleTest(TestCase):
    ...
    def test_get_all_price_rules(self):
        self.fake(
            "price_rules", method="GET", code=200, body=self.load_fixture("price_rules")
        )
    ...
    def test_update_price_rule(self):
        ...
        self.assertEqual(
            "Buy One Get One",
            json.loads(self.http.request.data.decode("utf-8"))["price_rule"]["title"],
        )
    ...
    def test_get_discount_codes(self):
        self.fake(
            ...
            method="GET",
            code=200,
            body=self.load_fixture("discount_codes"),
        )
    ...
    def test_add_discount_code(self):
        ...
        self.assertEqual(
            discount_code, json.loads(self.http.request.data.decode("utf-8"))
        )
        self.assertIsInstance(price_rule_discount_response, shopify.DiscountCode)
        self.assertEqual(
            discount_code["discount_code"]["code"], price_rule_discount_response.code
        )
    ...
    def test_create_batch_discount_codes(self):
        ...
        batch = self.price_rule.create_batch(
