...
class CollectionPublicationTest(TestCase):
    def test_find_all_collection_publications(self):
        ...
        collection_publications = shopify.CollectionPublication.find(
    ...
    def test_find_collection_publication(self):
        ...
        collection_publication = shopify.CollectionPublication.find(
            96062799894, publication_id=55650051
        )
    ...
    def test_create_collection_publication(self):
        ...
        self.assertEqual(
            expected_body, json.loads(self.http.request.data.decode("utf-8"))
        )
